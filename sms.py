...
class SendSms():
    ...
    def shad(self):
        ...
        shadD = {"api_version":"3","method":"sendCode","data":{"phone_number":{self.phone}("+90")[1],"send_type":"SMS"}}
        try:
    ...
    def gap(self):
        ...
        try:
            gapR = requests.get("https://core.gap.im/v1/user/add.json?mobile=%2B{}".format(self.phone("+90")[1]), headers=gapH, proxies=proxy)
            if "OK" in gapR.text:
